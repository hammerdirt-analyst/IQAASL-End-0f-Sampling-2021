...
bassin_map = "resources/maps/linth_city_labels.jpeg"

# the label for the aggregation of all data in the region
top = "Alle Erhebungsgebiete"

# define the feature level and components
# the feature of interest is the linth (linth) at the river basin (river_bassin) level.
...
# # Linth
# 
# {Download}`Download </resources/pdfs/linth_sa.pdf>`
...
# ```{figure} resources/maps/linth_city_labels.jpeg
# ---
# name: linth_survey_area_city_labels_map
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_city_labels_map>` {glue:text}`linth_city_map_caption`
...
glue("linth_dims_table_caption",dims_table_caption, display=False)
...
# ```{glue:figure} linth_dims_table
# ---
# name: 'linth_dims_table'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_dims_table>` {glue:text}`linth_dims_table_caption`
...
figure_name = "linth_survey_area_landuse"
...
# ```{glue:figure} linth_survey_area_landuse
# ---
# name: 'linth_survey_area_landuse'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_landuse>` {glue:text}`linth_land_use_caption`
...
glue("linth_sample_totals", fig, display=False)
plt.close()


# ```{glue:figure} linth_sample_totals
# ---
# name: 'linth_survey_area_sample_totals'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_sample_totals>` {glue:text}`linth_sample_total_notes`
...
plt.savefig(**save_figure_kwargs)
glue('linth_survey_area_sample_material_tables', fig, display=False)
plt.close()


# ```{glue:figure} linth_survey_area_sample_material_tables
# ---
# name: 'linth_survey_area_sample_material_tables'
# ---
# ` `
# ```

# {numref}`Abbildung %s: <linth_survey_area_sample_material_tables>` {glue:text}`linth_sample_summaries_caption`
...
glue('linth_most_common_caption', mc_caption_string, display=False)
glue('linth_most_common_tables', mcd, display=False)


# ```{glue:figure} linth_most_common_tables
# ---
# name: 'linth_survey_area_most_common_tables'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_most_common_tables>` {glue:text}`linth_most_common_caption`
...
# ```{glue:figure} linth_most_common_heat_map
# ---
# name: 'linth_survey_area_most_common_heat_map'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_most_common_heat_map>`{glue:text}`linth_mc_heat_map_caption`
...
glue("linth_monthly_results_caption", monthly_data_caption, display=False)
glue("linth_monthly_results", mcdm, display=False)


# ```{glue:figure} linth_monthly_results
# ---
# name: 'linth_monthly_results'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_monthly_results>` {glue:text}`linth_monthly_results_caption`
...
caption_spearmans = [
    ...
    f'im Erhebungsgebiet Linth. Für alle gültigen Erhebungen an Seen n={str(admin_summary["loc_date"])}. Legende: wenn p > 0,05 = weiss,  ',
...
plt.savefig(**save_figure_kwargs)
glue('linth_survey_area_spearmans', fig, display=False)
plt.close()


# ```{glue:figure} linth_survey_area_spearmans
# ---
# name: 'linth_survey_area_spearmans'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_spearmans>` {glue:text}`linth_spearmans_caption`
...
glue("linth_codegroup_percent_caption", code_group_percent_caption, display=False)
glue("linth_codegroup_percent", ptd, display=False)


# ```{glue:figure} linth_codegroup_percent
# ---
# name: 'linth_survey_area_codegroup_percent'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_codegroup_percent>` {glue:text}`linth_codegroup_percent_caption`
...
glue("linth_codegroup_pcsm_caption", code_group_pcsm_caption, display=False)
glue("linth_codegroup_pcsm", cgp, display=False)


# ```{glue:figure} linth_codegroup_pcsm
# ---
# name: 'linth_survey_area_codegroup_pcsm'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_codegroup_pcsm>` {glue:text}`linth_codegroup_pcsm_caption`
...
glue('linth_survey_area_rivers_summary_caption', rivers_caption, display=False)

glue('linth_survey_area_rivers_summary', fig, display=False)
plt.close()


# ```{glue:figure} linth_survey_area_rivers_summary
# ---
# name: 'linth_survey_area_rivers_summary'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_survey_area_rivers_summary>`{glue:text}`linth_survey_area_rivers_summary_caption`
...
mcd = most_common_display.style.format(aformatter).set_table_styles(table_css_styles)
glue('linth_rivers_most_common_caption', mc_caption_string, display=False)
glue('linth_rivers_most_common_tables', mcd, display=False)


# ```{glue:figure} linth_rivers_most_common_tables
# ---
# name: 'linth_rivers_most_common_tables'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_rivers_most_common_tables>` {glue:text}`linth_rivers_most_common_caption`
...
glue("linth_frag_table_caption", frag_captions, display=False)
glue("linth_frags_table", frags_table, display=False)
...
# ```{glue:figure} linth_frags_table
# ---
# name: 'linth_frags_table'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_frags_table>` {glue:text}`linth_frag_table_caption`

# ### Die Erhebungsorte

# ```{figure} resources/maps/linth_location_labels.jpeg
# ---
# name: linth_location_map
# ---
# ` `
# ```
# {numref}`Abbildung %s: <linth_location_map>` {glue:text}`lac-leman_city_map_caption` 
...
new_map_image =  Image('resources/maps/linth_location_labels.jpeg', width=cm*16, height=12*cm, kind="proportional", hAlign= "CENTER")
new_components = [
    KeepTogether([
        featuredata.large_space,
        location_subsection,

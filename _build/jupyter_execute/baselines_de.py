...
# *18. Mai 2020 Zählen von Abfallobjekten am Zürichsee, Richterswil; 3.49 Objekte pro Meter.*
...
# *Verschiedene Arten von Datenerhebungen:*
...
# *Zählen und Klassifizieren einer Probe:*
...
# *__Unter:__ Datenerhebungen Ergebnisse und zusammenfassende Statistiken: Proben größer als 10m und ohne Objekte kleiner als 2,5cm und Chemikalien, n=371*
...
# *__Unter:__ Verteilung der Datenerhebungen und Perzentilwerte: alle Erhebungen. Beachten Sie, dass der Mittelwert (341p/100m) größer ist als der Median (180p/100m)*
...
# *__Unter:__ Konfidenzintervalle berechnet mit der Percentile Bootstrap Methode*
...
# *__Unter:__ Konfidenzintervalle berechnet mit der BCa-Bootstrap-Methode*
...
the_first_table_data = axs.table(data, colLabels=collabels, colWidths=[.20,*[.1]*5], bbox=[0, 0, 1, 1])
...
# *__Unter:__ Der Median und das 95%-Konfidenzintervall der Erhebungsgebiete Linth, Aare und Rhône. Das Erhebungsgebiet Tessin ist mangels ausreichender Anzahl von Datenerhebungen nicht enthalten.*
...
# 
# *__Unter__: Die Grenze, ab der eine Datenerhebung als extrem gilt, erstreckt sich auf das 98. Perzentil, wenn die Boxplots angepasst werden, im Gegensatz zum 90. Perzentil, wenn die Konstante bei 1,5 belassen wird.*
...
# *__Unter:__ Beispiel für bereinigte Extremwerte: St. Gingolph, 08-12-2020. Es wurden 514 Objekte (pcs) über 31 Meter (m) Uferlinie gesammelt. Zunächst wird der Wert der Datenerhebungen in Abfallobjekte pro Meter (pcs/m) umgerechnet und dann mit der erforderlichen Anzahl von Metern (100) multipliziert:* 
# 
...
# *__Unter:__ Vergleichen Sie die Ausgangswerte der häufigsten Objekte. Alle Datenerhebungen 2020 - 2021. Das Erhebungsgebiet Ticino/Cerisio hat weniger als 100 Datenerhebungen.*
...
# *__Unter:__ Vergleichen Sie die Ausgangswerte der häufigsten Objekte. Aare-Erhebungsgebiet Seen und Flüsse 2020 - 2021. Orte mit mehr als 30 Datenerhebungen: Bielersee, Neuenburgersee und Thunersee.*

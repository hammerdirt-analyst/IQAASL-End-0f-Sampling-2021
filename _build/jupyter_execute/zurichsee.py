...
bassin_map = "resources/maps/zurichsee_city_labels.jpeg"
...
# ```{figure} resources/maps/zurichsee_city_labels.jpeg
# ---
# name: zurichsee_map
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_map>` {glue:text}`zurichsee_city_map_caption`
...
glue("zurichsee_dims_table_caption",dims_table_caption, display=False)
...
# ```{glue:figure} zurichsee_dims_table
# ---
# name: 'zurichsee_dims_table'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_dims_table>` {glue:text}`zurichsee_dims_table_caption`
...
figure_name = "zurichsee_sample_totals"
...
# ```{glue:figure} zurichsee_sample_totals
# ---
# name: 'zurichsee_sample_totals'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_sample_totals>` {glue:text}`zurichsee_sample_total_notes`
...
# ```{glue:figure} zurichsee_sample_summaries
# ---
# name: 'zurichsee_sample_summaries'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_sample_summaries>` {glue:text}`zurichsee_sample_summaries_caption` 
...
glue('zurichsee_most_common_caption', mc_caption_string, display=False)
glue('zurichsee_most_common_tables', mcd, display=False)


# ```{glue:figure} zurichsee_most_common_tables
# ---
# name: 'zurichsee_most_common_tables'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_most_common_tables>` {glue:text}`zurichsee_most_common_caption`
...
glue('zurichsee_most_common_heat_map', mcd, display=False)


# ```{glue:figure} zurichsee_most_common_heat_map
# ---
# name: 'zurichsee_most_common_heat_map'
# ---
# ` `
# ```

# {numref}`Abbildung %s: <zurichsee_most_common_heat_map>` {glue:text}`zurichsee_mc_heat_map_caption`
...
glue("zurichsee_monthly_results", mcdm, display=False)


# ```{glue:figure} zurichsee_monthly_results
# ---
# name: 'zurichsee_monthly_results'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_monthly_results>` zurichsee, monatliche Durchschnittsergebnisse p/100 m.
...
glue("zurichsee_codegroup_percent_caption", code_group_percent_caption, display=False)
glue("zurichsee_codegroup_percent", ptd, display=False)


# ```{glue:figure} zurichsee_codegroup_percent
# ---
# name: 'zurichsee_codegroup_percent'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_codegroup_percent>`  {glue:text}`zurichsee_codegroup_percent_caption` 
...
glue("zurichsee_codegroup_pcsm_caption", code_group_pcsm_caption, display=False)
glue("zurichsee_codegroup_pcsm", cgp, display=False)


# ```{glue:figure} zurichsee_codegroup_pcsm
# ---
# name: 'zurichsee_codegroup_pcsm'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_codegroup_pcsm>` {glue:text}`zurichsee_codegroup_pcsm_caption`
...
glue("zurichsee_frag_table_caption", frag_captions, display=False)
glue("zurichsee_frags_table", frags_table, display=False)
...
# ```{glue:figure} zurichsee_frags_table
# ---
# name: 'zurichsee_frags_table'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <zurichsee_frags_table>` {glue:text}`zurichsee_frag_table_caption`

# ### Die Erhebungsorte

# ```{figure} resources/maps/zurichsee_location_labels.jpeg
# ---
# name: zurichsee_location_map
# ---
# ` `
# ```
...
new_map_image =  Image('resources/maps/zurichsee_location_labels.jpeg', width=cm*14, height=11*cm, kind="proportional", hAlign= "CENTER")
new_components = [
    KeepTogether([
        featuredata.large_space,
        location_subsection,

...
# 
# 
# {Download}`Download </resources/pdfs/neuenburgersee.pdf>`
...
glue("neuenburgersee_dims_table_caption",dims_table_caption, display=False)
...
# ```{glue:figure} neuenburgersee_dims_table
# ---
# name: 'neuenburgersee_dims_table'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_dims_table>` {glue:text}`neuenburgersee_dims_table_caption`
...
figure_name = "neuenburgersee_sample_totals"
...
# ```{glue:figure} neuenburgersee_sample_totals
# ---
# name: 'neuenburgersee_sample_totals'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_sample_totals>` {glue:text}`neuenburgersee_sample_total_notes`
...
# ```{glue:figure} neuenburgersee_sample_summaries
# ---
# name: 'neuenburgersee_sample_summaries'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_sample_summaries>` {glue:text}`neuenburgersee_sample_summaries_caption` 
...
glue('neuenburgersee_most_common_caption', mc_caption_string, display=False)
glue('neuenburgersee_most_common_tables', mcd, display=False)


# ```{glue:figure} neuenburgersee_most_common_tables
# ---
# name: 'neuenburgersee_most_common_tables'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_most_common_tables>` {glue:text}`neuenburgersee_most_common_caption`
...
glue('neuenburgersee_most_common_heat_map', mcd, display=False)


# ```{glue:figure} neuenburgersee_most_common_heat_map
# ---
# name: 'neuenburgersee_most_common_heat_map'
# ---
# ` `
# ```

# {numref}`Abbildung %s: <neuenburgersee_most_common_heat_map>` {glue:text}`neuenburgersee_mc_heat_map_caption`
...
glue("neuenburgersee_monthly_results", mcdm, display=False)


# ```{glue:figure} neuenburgersee_monthly_results
# ---
# name: 'neuenburgersee_monthly_results'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_monthly_results>` neuenburgersee, monatliche Durchschnittsergebnisse p/100 m.
...
glue("neuenburgersee_codegroup_percent_caption", code_group_percent_caption, display=False)
glue("neuenburgersee_codegroup_percent", ptd, display=False)


# ```{glue:figure} neuenburgersee_codegroup_percent
# ---
# name: 'neuenburgersee_codegroup_percent'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_codegroup_percent>`  {glue:text}`neuenburgersee_codegroup_percent_caption` 
...
glue("neuenburgersee_codegroup_pcsm_caption", code_group_pcsm_caption, display=False)
glue("neuenburgersee_codegroup_pcsm", cgp, display=False)


# ```{glue:figure} neuenburgersee_codegroup_pcsm
# ---
# name: 'neuenburgersee_codegroup_pcsm'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_codegroup_pcsm>` {glue:text}`neuenburgersee_codegroup_pcsm_caption`
...
# ```{glue:figure} neuenburgersee_frags_table
# ---
# name: 'neuenburgersee_frags_table'
# ---
# ` `
# ```
# {numref}`Abbildung %s: <neuenburgersee_frags_table>` {glue:text}`neuenburgersee_frag_table_caption`

# ### Die Erhebungsorte

# ```{figure} resources/maps/neuenburgersee_location_labels.jpeg
# ---
# name: neuenburgersee_location_map
# ---
# ` `
# ```

...
this_feature = {'slug':'linth', 'name':"Linth survey area", 'level':'river_bassin'}
...
# *Karte des Erhebungsgebiets March 2020 - Mai 2021. Markierungsdurchmesser = das mittlere Erhebungsergebnis in Müllstücken pro 100 Meter (p/100m).*
...
fig, axs = plt.subplots(figsize=(16,len(data)*.8))

...
# *__Below:__ Counting beach litter on Zurichsee. Richterswill May 18, 2020 3.49 pieces of trash per meter.*
...
# 
# 1. Robust with respect to outliers 
...
# *__Below:__ Confidence intervals calculated using the Percentile bootstrap method*
...
# *__Below:__ Confidence interval example value: the survey result at Biel on 31-01-2021 was greater than the median value for all the surveys. There were 123 objects (pcs) collected over 40 meters (m) of shoreline. First the survey value is converted to **pieces of litter per meter (pcs/m)** and then multiplied by the required number of meters (100).* 
# 
...
# *__Below:__ Confidence intervals calculated using the BCa bootstrap method*

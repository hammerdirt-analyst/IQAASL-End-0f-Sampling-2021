...
bassin_map = PILImage.open("resources/maps/leman_scaled.jpeg")
...
# 
# *Marker diameter = the median survey result in pieces of trash per 100 meters (p/100m).*
...
# 3. Hackuarium
# 4. Solid Waste Engineering (EPFL)
# 5. Hammerdirt

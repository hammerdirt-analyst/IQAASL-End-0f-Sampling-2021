...
name_of_project = 'bassin_report_rhone'

# set the maps
bassin_map = PILImage.open("resources/maps/rhone_scaled.jpeg")
land_use_map = PILImage.open("resources/maps/land_use_rhone.jpeg")

# the search term for the river bassin
bassin_name = 'rhone'

lakes_of_interest = ['lac-leman']
lake_colors=["darkblue"]


# the names for the survey area and the cumulative data
level_names = ["Rhône survey area","All survey areas"]

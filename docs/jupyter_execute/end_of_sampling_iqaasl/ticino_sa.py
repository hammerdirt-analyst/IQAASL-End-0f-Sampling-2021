...
name_of_project = 'bassin_report_ticino'

# set the maps
bassin_map = PILImage.open("resources/maps/ticino_scaled.jpeg")
land_use_map = PILImage.open("resources/maps/land_use_ticino.jpeg")
...
level_names = ["Ticino survey area","All survey areas"]

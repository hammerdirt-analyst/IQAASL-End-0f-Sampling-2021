...
{numref}`Figura {number}: <esummarysurveyareas_fr_de>` *Tous les lacs et rivières par région : Le résultat médian de l'inventaire des objets les plus fréquemment identifiés ; les taux varient en fonction de la région de la zone d'enquête. Par exemple, les plastiques fragmentés avaient la plus grande valeur médiane dans les zones d'enquête de l'Aar (18,5p/100m) et du Rhône (48p/100m).* 
